                ...
                <div class="box-import box-shadow mb-30">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 d-flex align-items-center">
                            <div class="row">
                                <div class="col-lg-5 col-md-12">
                                    <div>
                                        <h3 class="large-title c-primary"><?php esc_html_e( 'Import Demo', 'huntor' ) ?></h3>
										<?php if ( $status['plugin_required'] ) { ?>
                                            <p class="text-description"><?php esc_html_e( 'Please check and make sure that all required plugins are set up on your website', 'huntor' ) ?></p>
                                            <a href="<?php echo esc_url( admin_url( 'admin.php?page=lexus-theme-plugins' ) ); ?>"
                                               class="opal-btn-primary"><?php esc_html_e( 'Install Plugins', 'huntor' ) ?></a>
										<?php } else { ?>
                                            <p class="text-description"><?php esc_html_e( 'Clone a demo site in few clicks', 'huntor' ) ?></p>
                                            <a href="<?php echo esc_url( admin_url( 'admin.php?page=pt-one-click-demo-import' ) ); ?>"
                                               class="opal-btn-primary"><?php esc_html_e( 'Run Importer', 'huntor' ) ?></a>
										<?php } ?>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-12 bl-lg-so-1 d-flex align-items-center">
                            <div class="pl-lg-2">
                                <h2 class="medium-title pb-3 mt-lg-0"><?php esc_html_e( 'System Status', 'huntor' ) ?></h2>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow mb-30">
                    <img class="img-auto"
                         ...
                         title="wp opal">
                    <h3><?php esc_html_e( 'Support Cover', 'huntor' ) ?></h3>
                    <p><?php esc_html_e( 'We’ll give you a reply within 24 hours except during weekends.', 'huntor' ) ?></p>
                    <div class="box-footer">
                        <a href="https://themelexus.ticksy.com/" target="_blank"
                           class="opal-btn-secondary mt-4"><?php esc_html_e( 'Submit Ticket', 'huntor' ) ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow">
                    <img class="img-auto"
                         ...
                         title="wp opal">
                    <h3><?php esc_html_e( 'Documentation', 'huntor' ) ?></h3>
                    <p><?php esc_html_e( 'Read all documentation for our themes. Any questions or training needed for WordPress themes can be  found here.', 'huntor' ) ?></p>
                    <div class="box-footer">
                        <a href="<?php echo esc_url('http://wpdocs.gitbook.io/huntor') ?>" class="opal-btn-primary mt-4"><?php esc_html_e( 'Explore Now', 'huntor' ) ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow">
                    <img class="img-auto"
                         ...
                         title="wp opal">
                    <h3><?php esc_html_e( 'Our Information', 'huntor' ) ?></h3>
                    <p><?php esc_html_e( 'Checkout our site and social for more information.', 'huntor' ) ?></p>
                    <a href="https://www.wpopal.com/"
                       class="mb-3"><?php esc_html_e( 'www.wpopal.com', 'huntor' ); ?></a>
